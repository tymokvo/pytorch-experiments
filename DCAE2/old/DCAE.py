...
class Decoder(nn.Module):
    def __init__(self, nz, ngf, nc=3):
        ...
        self.layers = odict([
            #block 0
            ('convT_0', nn.ConvTranspose2d(nz, ngf * 32, 4, stride=2, padding=1, bias=False)),
            ('bn_0', nn.BatchNorm2d(ngf * 32)),
            ('act_0', nn.LeakyReLU(inplace=True)),
            #block 1
            ('convT_1', nn.ConvTranspose2d(ngf * 32, ngf * 16, 4, stride=2, padding=1, bias=False)),
            ('bn_1', nn.BatchNorm2d(ngf * 16)),
            ('act_1', nn.LeakyReLU(inplace=True)),
            #block 2
            ('convT_2', nn.ConvTranspose2d(ngf * 16, ngf * 16, 4, stride=2, padding=1, bias=False)),
            ('bn_2', nn.BatchNorm2d(ngf * 16)),
            ('act_2', nn.LeakyReLU(inplace=True)),
            #block 3
            ('convT_3', nn.ConvTranspose2d(ngf * 16, ngf * 16, 4, stride=2, padding=1, bias=False)),
            ('bn_3', nn.BatchNorm2d(ngf * 16)),
            ('act_3', nn.LeakyReLU(inplace=True)),
            #block 4
            ('convT_4', nn.ConvTranspose2d(ngf * 16, ngf * 32, 4, stride=2, padding=1, bias=False)),
            ('bn_4', nn.BatchNorm2d(ngf * 32)),
            ('act_4', nn.LeakyReLU(inplace=True)),
            #block 5
            ('convT_5', nn.ConvTranspose2d(ngf * 32, ngf * 16, 4, stride=2, padding=1, bias=False)),
            ('bn_5', nn.BatchNorm2d(ngf * 16)),
            ('act_5', nn.LeakyReLU(inplace=True)),
            #block 6
            ('convT_6', nn.ConvTranspose2d(ngf * 16, ngf * 16, 4, stride=2, padding=1, bias=False)),
            ('bn_6', nn.BatchNorm2d(ngf * 16)),
            ('act_6', nn.LeakyReLU(inplace=True)),
            #block 7
            ('convT_7', nn.ConvTranspose2d(ngf * 16, ngf * 8, 4, stride=2, padding=1, bias=False)),
            ('bn_7', nn.BatchNorm2d(ngf * 8)),
            ('act_7', nn.LeakyReLU(inplace=True)),
            #block 8
            ('convT_8', nn.ConvTranspose2d(ngf * 8, nc, 4, stride=2, padding=1, bias=False)),
